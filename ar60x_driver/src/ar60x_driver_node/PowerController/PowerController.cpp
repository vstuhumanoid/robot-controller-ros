...
{
    robot_supply_state_publisher_ = nh_.advertise<robot_msgs::SourcesSupplyState>(namespace_ + "/sources_state", 100);
    joints_supply_state_publiser_ = nh_.advertise<robot_msgs::JointsSupplyState>(namespace_ + "/joints_state", 100);
