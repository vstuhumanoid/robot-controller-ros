...
void JointsController::init_topics()
{
    ...
    joint_params_publisher_ = nh_.advertise<robot_msgs::JointsParams>(namespace_ + "/get_params", 100, true);
...
void JointsController::joint_command_cb(robot_msgs::JointsCommand msg)
{
    driver_.JointsSetCommand(msg);
}

void JointsController::joint_params_cb(robot_msgs::JointsParams msg)
{
...
void JointsController::joint_mode_cb(robot_msgs::JointsMode msg)
{
    // We should re-publish joints params when something is changed
