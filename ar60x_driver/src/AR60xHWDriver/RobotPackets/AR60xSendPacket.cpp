...
AR60xSendPacket::AR60xSendPacket(AR60xDescription& robotDesc) : BasePacket(robotDesc)
{
    ...
    for (auto &it : desc_.joints)
    {
        ...
        robot_msgs::TypeJointMode mode;
        mode.mode = robot_msgs::TypeJointMode::BREAK;
...
void AR60xSendPacket::JointSetPIDGains(JointData &joint, robot_msgs::TypePid gains)
{
...
void AR60xSendPacket::JointSetMode(JointData &joint, robot_msgs::TypeJointMode mode)
{
